...
- (void)setupSubViews{
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:NSStringFromClass(GITabCollectionViewCell.class) bundle:nil] forCellWithReuseIdentifier:TAB_COLLECTION_VIEW_CELL];
